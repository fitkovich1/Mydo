...
export const navbarItems = [
    {icon: shopIcon, iconActive: shopActiveIcon, alt: 'shop icon', name: 'shop', path: MAIN_ROUTES.SHOP},
    {icon: forYouIcon, iconActive: forYouActiveIcon, alt: 'for you icon', name: 'for_you', path: MAIN_ROUTES.FOR_YOU},
    {icon: scannerIcon, iconActive: scannerActiveIcon, alt: 'scanner icon', name: 'scanner', path: MAIN_ROUTES.SCANNER},
    {icon: activitiesIcon, iconActive: activitiesActiveIcon, alt: 'activities icon', name: 'activities', path: MAIN_ROUTES.ACTIVITIES},
    {icon: loginIcon, iconActive: loginActiveIcon, alt: 'login icon', name: 'login', path: MAIN_ROUTES.LOGIN}
];